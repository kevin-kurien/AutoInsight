  ...
  const handleUpload = () => {
    ...
    files.forEach((fileObj) => {
      ...
      intervalRefs.current[fileObj.id] = setInterval(() => {
        // Randomize progress increments for more realistic simulation
        const increment = Math.random() * (fileObj.size > 10 * 1024 * 1024 ? 5 : 15);
        progress += increment;
        ...
        if (progress >= 100) {
          ...
          if (completedCount === files.filter(f => f.status === 'ready').length) {
          ...
          {uploadedFiles.length > 0 && (
            ...
            >
              ...
              <div className={styles.successActions}>
                <Button variant="success" className={styles.continueButton}>
